...
static void initBase64DecodeTable()
{
	...
	for (i = 'A'; i <= 'Z'; ++i) base64DecodeTable[i] = char(0 + (i - 'A'));
	for (i = 'a'; i <= 'z'; ++i) base64DecodeTable[i] = char(26 + (i - 'a'));
	for (i = '0'; i <= '9'; ++i) base64DecodeTable[i] = char(52 + (i - '0'));
