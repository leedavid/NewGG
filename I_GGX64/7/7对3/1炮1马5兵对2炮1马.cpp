#ifndef END_my_m_MT_R_1pao1ma5pawn_B_2pao1ma
#define END_my_m_MT_R_1pao1ma5pawn_B_2pao1ma
#include "..\\..\\chess.h"
#include "..\\..\\preGen.h"
 
#include "..\\..\\endgame\mat.h"
#include "1ÅÚ1Âí5±ø¶Ô2ÅÚ1Âí.cpp"
#include "..\\..\\white.h"
#else
#include "..\\..\\black.h"
#endif 
...
void my_m_MT_R_1pao1ma5pawn_B_2pao1ma(typePOS &POSITION, EvalInfo &ei){
	...
	//MY_EV_SUB((sint16)count_1s(ymp) * ADD_2pao1ma_2pao1pawn_ByShi[my_shi_num]);
	//fen 9/C3k4/3N1aNn1/6p2/9/3pp3p/1p5c1/9/4A4/4KAB2 w - - 0 1
	MY_EV_ADD(mcan * ADD_2pao1ma_1pao1maXpawn_ByShi[your_shi_num]);
}

//void m_MT_B_1pao1ma5pawn_R_2pao1ma(typePOS &POSITION, EvalInfo &ei){
///*
