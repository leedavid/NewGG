#ifndef END_my_m_MT_R_1ma1pao5pawn_B_1che1pawn
#define END_my_m_MT_R_1ma1pao5pawn_B_1che1pawn
#include "..\\..\\chess.h"
#include "..\\..\\preGen.h"
 
#include "..\\..\\endgame\mat.h"
#include "1炮1马5兵对1车1兵.cpp"
#include "..\\..\\white.h"
#else
#include "..\\..\\black.h"
#endif 
...
// 红方马炮兵,黑方车兵
void my_m_MT_R_1ma1pao5pawn_B_1che1pawn(typePOS &POSITION, EvalInfo &ei){
...
// 黑方马炮兵,红方车兵
//void m_MT_B_1ma1pao5pawn_R_1che1pawn(typePOS &POSITION, EvalInfo &ei){
///*
//	Square rpawn = PieceListStart(board,RPAWN);
//	Square rk = PieceListStart(board,RKING);
//	Square bk = PieceListStart(board,BKING);
//
//	if(m_MT_R_1che1pawn_B_1pao1ma(board) == 1){
//		board->bsafe = TRUE;
//	}
//
