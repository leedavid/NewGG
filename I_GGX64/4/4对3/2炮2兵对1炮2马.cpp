...
void my_m_MT_R_2pao2pawn_B_1pao2ma(typePOS &POSITION, EvalInfo &ei){
	// ADD_MY
	Square yk = your_king_pos;
	Bitboard bmp = m_and(bb_my_pawn,MyLowBB[StoY(yk)]);
	int pmok = (int)count_1s(bmp);
	MY_EV_ADD(pmok * ADD_1pao2ma_2paoXpawn_ByShi[your_shi_num]);
	
}
//
//void m_MT_B_2pao2pawn_R_1pao2ma(typePOS &POSITION, EvalInfo &ei){
///*
