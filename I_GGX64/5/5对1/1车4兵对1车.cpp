#ifndef END_my_m_MT_R_1CHE_4PAWN_B_1CHE
#define END_my_m_MT_R_1CHE_4PAWN_B_1CHE
#include "..\\..\\chess.h"
#include "..\\..\\preGen.h"
...
//我方一车4兵，对方一车
void my_m_MT_R_1CHE_4PAWN_B_1CHE(typePOS &POSITION, EvalInfo &ei){
	...
	if(your_shi_num == 2 && your_xiang_num == 2 && MY_SQ04 == yk){
		...
		// fen 4k1b2/1PP1a4/4ba3/1r7/9/2PR4P/9/9/4A4/4KA3 b - - 0 1
		Bitboard myghp = m_and(bb_my_pawn,MyUpBB[MY_RANK5]);
		if(count_1s(myghp) <= 2){
			if(!m_have_bit(m_and(myghp,m_and(LeftBB[0x06],RightBB[0x02])))){
				MY_EV_SUB(128);
			}
		}
	}
...
//我方一车4兵，对方一车
//void m_MT_B_1CHE_4PAWN_R_1CHE(typePOS &POSITION, EvalInfo &ei){
//	/*	
