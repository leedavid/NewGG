...
// utils
VMP_IMPORT int VMP_API VMProtectIsProtected();
VMP_IMPORT int VMP_API VMProtectIsDebuggerPresent(bool);
VMP_IMPORT int VMP_API VMProtectIsVirtualMachinePresent(void);
VMP_IMPORT int VMP_API VMProtectIsValidImageCRC(void);
...
VMP_IMPORT int VMP_API VMProtectFreeString(const void *value);
...
VMP_IMPORT int VMP_API VMProtectGetSerialNumberData(VMProtectSerialNumberData *data, int size);
